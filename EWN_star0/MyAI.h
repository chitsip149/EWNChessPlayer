...
private:
    ...
    // Star0 Algorithm
    bool is_terminal_state(MyAI game_state);
    double evaluate_state(MyAI game_state);
    double F_MAX(int piece, MyAI game_state, double alpha, double beta, int depth);
    double G_MIN(int piece, MyAI game_state, double alpha, double beta, int depth);
    double Star0_F(MyAI game_state, double alpha, double beta, int depth);
    double Star0_G(MyAI game_state, double alpha, double beta, int depth);
};
